    ...
    <section className="mb-10">
      ...
      <div className="flex flex-col gap-2">
        {TEMPLATE_FIELDS.map(({ key, label, desc }) => (
          <div
            key={key}
            className="flex items-center justify-between border border-stone-100 rounded-xl px-4 py-3 hover:border-stone-200 transition-colors"
          >
            <div>
            ...
            <button
              ...
              className={`w-10 h-6 rounded-full transition-colors relative flex-shrink-0 ${template[key] ? "bg-indigo-500" : "bg-stone-200"}`}
            >
              <span
