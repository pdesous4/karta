        ...
        <form onSubmit={handleCreateDeck} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setDeckForm((p) => ({ ...p, title: e.target.value }))
              }
              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-gray-400"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setDeckForm((p) => ({ ...p, language: e.target.value }))
              }
              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-gray-400"
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                setDeckForm((p) => ({ ...p, is_public: e.target.checked }))
              }
              className="rounded"
            />
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  disabled={
                    generatingAll || !cards.some((c) => c.back && !c.audio_url)
                  }
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
            ...
            <p className="text-sm text-gray-400">
              {deck.language} · {cards.filter((c) => c.front && c.back).length}{" "}
              cards
            </p>
          </div>
